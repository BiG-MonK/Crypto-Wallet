...
var coinTrade = { 
  deal_1: {exchange: "Poloniex", time: "06.12.2017", type: "BUY",  target: "ETH", sum: 3,             rurUsd: 58.7,  priceUsd: 420.40},
...
html = '';
html += "<p class='deal_1'>" + (ethUsd / 1).toFixed(2) + " (" + (100 - coinTrade.deal_1.priceUsd / ethUsd * 100).toFixed(2) + " %)</p><br>";
