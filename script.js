...
var coinTrade = { 
  deal_1: {exchange: "Poloniex", time: "06.12.2017", type: "BUY",  target: "NXT", sum: 2499.56767806, rurUsd: 58.7,  priceUsd: 0.3883},
...
html = '';
html += "<p class='deal_1'>" + (nxtUsd / 1).toFixed(2) + " (" + (100 - coinTrade.deal_1.priceUsd / nxtUsd * 100).toFixed(2) + " %)</p><br>";
...
html = '';
html += "<p class='deal_1'>" + (((nxtUsd * coinTrade.deal_1.sum) - (coinTrade.deal_1.priceUsd * coinTrade.deal_1.sum)) * rur_usd).toFixed(2) + " руб.</p><br>";
